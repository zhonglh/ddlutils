...
public class DdlUtilsBaseTest {
    ...
    public void setup(){
        ...
        mysqlDataSource.setUrl("jdbc:mysql://localhost:3306/my-lamp?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8");
